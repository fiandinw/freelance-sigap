      ...
      <div className="bg-abuabu min-h-screen">
        <div className="flex flex-row min-h-screen items-center">
          <form ref={formRef} onSubmit={handleLogin} className="w-[700px] px-14 py-24 self-stretch">
            <div className="bg-hijau-tua rounded-3xl text-putih p-12 h-full flex flex-col justify-between">
              ...
              <div className="flex flex-col gap-8">
                <div>
                  <button type="button" className="py-2 px-4 flex justify-center items-center bg-hijau-dark hover:bg-red-700 focus:ring-red-500 focus:ring-offset-red-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
          ...
          <div className="grow h-screen py-24 pr-20 flex flex-col justify-between">
            ...
            <div className="grow">
              <div ref={titleRef} className="uppercase text-hijau-tua text-7xl font-bold">freelance sigap</div>
