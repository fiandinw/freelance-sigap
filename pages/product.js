    ...
    <div className="bg-abuabu min-h-screen font-lato">
      ...
      <main className="pt-32 pb-32 px-8 flex flex-col min-h-screen gap-8">
        ...
        <div className="relative max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="pricing-box max-w-lg mx-auto rounded-lg shadow-lg overflow-hidden lg:max-w-none lg:flex text-abuabu">
            <div className="bg-hijau-tua dark:bg-gray-800 px-6 py-8 lg:flex-shrink-1 lg:p-12">
            ...
            <div className="py-8 px-6 text-center bg-hijau-med dark:bg-gray-700 lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-12">
              ...
              <div className="mt-6">
                <div className="rounded-md flex flex-col gap-4">
                  <Link href="/custom-order" passHref>
                    <button type="button" className="py-2 px-4 bg-hijau-tua hover:bg-indigo-700 focus:ring-indigo-500 focus:ring-offset-indigo-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                      Chat and Nego
                    </button>
                  </Link>
