      ...
      <div className="bg-abuabu min-h-screen">
        ...
        <main className="pt-32 pb-12">
          <form onSubmit={handleSubmit} className="flex flex-col w-screen items-center px-32 gap-4">
            ...
            <div className="w-full">
              <label className="text-hijau-tua font-semibold text-xl" htmlFor="jenisFreelance">Jenis Freelance</label>
            ...
            <div className="w-full">
              ...
              <ol className="list-decimal pl-4">
                ...
                <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde perspiciatis dignissimos minus vero doloribus?</li>
                <li>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Distinctio dicta perspiciatis blanditiis, accusantium, aliquid cumque magnam animi inventore culpa, nam quaerat repudiandae quam exercitationem.</li>
                <li>lorem</li>
              </ol>
            </div>
            <div className="w-full">
